...
public class MainActivity extends ListActivity {
    ...
    String[] things = { "Рубик", "Иллюзия", "Картина", "Часы", "Yadreev Egor"};
    @Override
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position){
                    case 0:
                        ...
                        break;
                    case 1:
                        Intent intent2 = new Intent( MainActivity.this, Illision.class);
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        Intent intent5 = new Intent( MainActivity.this, Yadreev_Egor.class);
